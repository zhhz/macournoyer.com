...
filter:
  ...
  - textile
--- 
I was getting tired of my "old blog":http://macournoyer.wordpress.com and wanted to play with CSS and code a lil' bit. So here's the result. I must say, I'm pretty happy with the result. 3 new tools, I've never (heavily) used before, helped me with that.
...
I also took the time to <a href="javascript:void(0)" onclick="$('body').toggleClass('showgrid')">align everything to the grid</a>.
